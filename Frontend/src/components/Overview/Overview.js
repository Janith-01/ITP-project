...
const OverviewPage = () => {
  ...
  const fetchTotalIncome = async () => {
    try {
      const response = await axios.get('http://localhost:8083/api/totalIncome');
  ...
  const fetchTotalExpense = async () => {
    try {
      const response = await axios.get('http://localhost:8083/api/totalExpense');
  ...
  const fetchBalance = async () => {
    try {
      const response = await axios.get('http://localhost:8083/totalBalance');
      console.log('Balance:', response.data.totalBalance);
