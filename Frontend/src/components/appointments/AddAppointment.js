...
function AddAppointment() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        await axios.post('http://localhost:8083/users/appointments', appointment);
        setAppointment({
          date: '',
          time: '',
          description: '',
        ...
        // Navigate to the Appointments page after successful submission
        history('/allapp');// This will navigate to the Appointments page
      } catch (error) {
